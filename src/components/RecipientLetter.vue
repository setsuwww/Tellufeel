...
<template>
  <section class="flex min-h-screen items-center justify-center px-5 py-10">
    <article data-cy="recipient-letter"
      ...
      <div v-if="!confession.response" class="mt-8">
        ...
        <div class="flex gap-3">
          <button type="button" data-cy="response-no" :disabled="submitting"
          ...
          <button type="button" data-cy="response-yes" :disabled="submitting"
        ...
        <form v-if="showReasonForm" ref="reasonForm" class="mt-4" @submit.prevent="handleReject">
          <textarea v-model="reason" rows="4" :disabled="submitting" placeholder="Kenapa? Kasih tahu alasannya..."
          ...
          <button type="submit" data-cy="submit-reason" :disabled="submitting || !reason.trim()"
      ...
      <div v-if="confession.response" class="mt-8 rounded-sm border border-pink-500/20 bg-pink-500/5 p-4">
        <div class="flex items-center gap-3">
          ...
          <div>
            <p data-cy="response-success" class="font-sans text-sm font-semibold text-pink-300">
