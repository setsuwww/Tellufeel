...
<template>
    <section class="flex min-h-screen items-center justify-center px-5 text-center">
        <div class="w-full max-w-2xl">
            ...
            <!-- Eyebrow -->
            <p ref="eyebrow" class="font-sans text-xs font-bold tracking-[0.22em] text-pink-400">
                ADA SESUATU UNTUK KAMU
            </p>

            <!-- Title -->
            <h1 ref="title" class="mt-4 font-serif text-4xl font-semibold leading-tight text-slate-50 sm:text-5xl">
                Ada seseorang
                <br />
            ...
            <!-- Description -->
            <p ref="description" class="mx-auto mt-6 max-w-md font-sans text-sm leading-7 text-slate-500">
                Mungkin sederhana.
                <br />
