...
async function handleSubmit() {
  ...
  try {
    ...
    recipientUrl.value = `${window.location.origin}/c/${result.confession.cuid}?token=${result.recipientToken}`;

    console.log("CREATE SUCCESS:", result);
    console.log("RECIPIENT URL:", recipientUrl.value);
...
<template>
  <main
    ...
    <section ref="formCard"
      ...
      <!-- Form -->
      <form v-if="!recipientUrl" ref="form" class="space-y-5" @submit.prevent="handleSubmit">
        <div>
          <label for="senderName" class="mb-2 block font-sans text-sm font-medium text-slate-300">
            Nama kamu
          </label>

          <input id="senderName" v-model="senderName" name="senderName" type="text" autocomplete="name"
        ...
        <div>
          ...
          <input id="recipientName" v-model="recipientName" name="recipientName" type="text"
        ...
        <div>
          ...
          <textarea id="message" v-model="message" name="message" rows="6" placeholder="Tulis confess kamu di sini..."
        ...
        <button type="submit" data-cy="create-confession-submit" :disabled="loading"
      ...
      <!-- Result -->
      <section v-else ref="resultCard" data-cy="confession-result" class="space-y-6">
        <!-- Success Banner -->
        <div class="rounded-sm border border-pink-500/30 bg-pink-500/10 p-5">
          ...
          <h2 data-cy="confession-success" class="mt-2 font-serif text-3xl font-semibold leading-tight text-pink-300">
            Confess kamu siap.
          </h2>
        ...
        <div>
          ...
          <input id="recipientUrl" data-cy="recipient-url" :value="recipientUrl" type="text" readonly
        ...
        <div class="grid gap-3 sm:grid-cols-2">
          <button type="button" data-cy="copy-link"
          ...
          <button type="button" data-cy="create-new-confession"
            ...
            @click="createNewConfession">
            Buat Lagi
          </button>
        </div>

        <button type="button" data-cy="go-dashboard"
