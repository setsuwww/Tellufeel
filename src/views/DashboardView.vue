...
<template>
    <main class="relative min-h-screen overflow-hidden bg-slate-950 px-4 py-8 text-slate-50 sm:px-6 sm:py-12">
        ...
        <div ref="dashboard" class="relative mx-auto w-full max-w-4xl">
            <!-- Header -->
            ...
            <!-- Loading -->
            <div v-if="loading" class="rounded-md border border-slate-800 bg-slate-900 p-8 text-center">
            ...
            <!-- Error -->
            <div v-else-if="error" class="rounded-md border border-pink-900/50 bg-pink-950/20 p-6">
            ...
            <!-- Empty -->
            <div v-else-if="confessions.length === 0"
            ...
            <section v-else class="space-y-5">
                <article v-for="confession in confessions" :key="confession.id"
                    ...
                    <!-- Pending -->
                    <div v-else class="mt-5 flex items-center gap-3 border-t border-slate-800 pt-5">
